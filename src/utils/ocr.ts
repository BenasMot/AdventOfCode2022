// By https://github.com/shahata
// https://github.com/shahata/adventofcode-solver/blob/master/src/utils/ocr.js
...
export function ocr(image: string) {
  ...
  for (let i = 0; i < letters; i++) {
    ...
    result += alphabet[letter.join("") as keyof typeof alphabet];
  }
